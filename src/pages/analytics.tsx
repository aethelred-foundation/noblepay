...
function generateVolumeTrend(baseSeed: number): VolumeTrendPoint[] {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    const usdc = total * (0.4 + seededRandom(s + 1) * 0.1);
    const usdt = total * (0.25 + seededRandom(s + 2) * 0.1);
    const aet = total * (0.15 + seededRandom(s + 3) * 0.1);
    data.push({
      day: `Mar ${i + 1}`,
...
export default function AnalyticsPage() {
  ...
  const complianceScreening = useMemo(
    () => generateComplianceScreening(45000),
    [],
  );
    ...
    <>
      ...
      <div className="min-h-screen bg-[#0f172a] text-slate-100">
        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <SectionHeader
            title="Volume Trends"
            subtitle="30-day payment volume with currency breakdown"
            size="sm"
          />
          ...
          <SectionHeader
            ...
            subtitle="Breakdown by currency, status, and business tier"
            size="sm"
          />
          ...
          {/* ================================================================
              ...
              ================================================================ */}
          <SectionHeader
            title="Geographic Flow Map"
            subtitle="Top 10 payment corridors by volume"
            size="sm"
          />
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-700/50 text-left text-xs uppercase tracking-wider text-slate-400">
                  ...
                  <th className="py-3 w-40 hidden xl:table-cell">
                    Relative Volume
                  </th>
                </tr>
              </thead>
              <tbody>
                {corridors.map((c, idx) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4 text-slate-300 hidden sm:table-cell">
                      {c.count.toLocaleString()}
                    </td>
                    <td className="py-3 pr-4 text-slate-300 hidden md:table-cell">
                      {c.avgSettlement}
                    </td>
                    <td className="py-3 pr-4 hidden lg:table-cell">
                      <span
                        className={`text-xs font-medium ${c.complianceRate >= 97 ? "text-emerald-400" : "text-amber-400"}`}
                      >
          ...
          <SectionHeader
            ...
            subtitle="Average and 95th percentile settlement times vs SLA target"
            size="sm"
          />
          <GlassCard className="p-6 mb-10" hover={false}>
            <ResponsiveContainer width="100%" height={320}>
              <LineChart data={settlementPerf}>
                ...
                />
                <RechartsTooltip
                  content={<ChartTooltip formatValue={(v) => `${v} min`} />}
                />
                <Legend />
                <Line
                  type="monotone"
          ...
          <SectionHeader
            ...
            subtitle="Screening results and latency monitoring"
            size="sm"
          />
            ...
            <GlassCard className="p-6" hover={false}>
              ...
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={screeningLatency}>
                  ...
                  />
                  <RechartsTooltip
                    content={<ChartTooltip formatValue={(v) => `${v}ms`} />}
                  />
                  <Legend />
                  <Line
                    type="monotone"
          ...
          {/* ================================================================
              ...
              ================================================================ */}
          <SectionHeader
            title="Top Businesses Leaderboard"
            subtitle="Ranked by total payment volume"
            size="sm"
          />
          <GlassCard className="p-6 mb-10 overflow-x-auto" hover={false}>
            <table className="w-full text-sm">
              ...
              <tbody>
                {businesses.map((b) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4 text-slate-300 hidden md:table-cell">
                      ${formatNumber(b.avgSize)}
                    </td>
                    <td className="py-3 pr-4 hidden lg:table-cell">
                      <span
                        className={`text-xs font-medium ${b.complianceScore >= 97 ? "text-emerald-400" : b.complianceScore >= 95 ? "text-amber-400" : "text-red-400"}`}
                      >
                        {b.complianceScore}%
                      </span>
                    </td>
          ...
          <SectionHeader
            ...
            subtitle="Daily fee revenue split by type with cumulative total"
            size="sm"
          />
          <GlassCard className="p-6 mb-10" hover={false}>
            <ResponsiveContainer width="100%" height={360}>
