...
function generateAPIKeys(baseSeed: number): APIKey[] {
  ...
  return names.map((name, i) => {
    ...
    return {
      ...
      status:
        seededRandom(s + 4) > 0.2 ? ("Active" as const) : ("Revoked" as const),
    };
  });
}
...
function generateSessions(baseSeed: number): Session[] {
  ...
  return devices.map((d, i) => {
    ...
    return {
      ...
      location: d.location,
      lastActive:
        i === 0 ? "Now" : `${Math.floor(1 + seededRandom(s + 4) * 48)}h ago`,
      current: i === 0,
    };
  });
}
...
function ProfileTab() {
  ...
  const [complianceOfficer, setComplianceOfficer] = useState(
    "aeth1q9f8k3m2p7w4x5v6n8b1c0d3e4f5g6h7j8k9l0m1n2",
  );
  const [contactEmail, setContactEmail] = useState(
    "compliance@alansari-exchange.ae",
  );
    ...
    <div className="space-y-6">
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          <FormField
            label="Business Name"
            value="Al Ansari Exchange"
            readOnly
          />
          <FormField
            label="License Number"
            value="ADGM-FSP-2024-0847"
            readOnly
          />
          <FormField
            label="Jurisdiction"
    ...
    <div className="space-y-6">
      ...
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="space-y-2 mt-6">
          ...
          />
          <SliderField
            label="Manual review required above"
            value={manualReview}
            min={50}
            max={100}
          ...
          />
          <SliderField
            label="Auto-block above risk score"
            value={autoBlock}
            min={70}
            max={100}
        ...
        <div className="mt-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              value={eddThreshold}
              onChange={(e) =>
                setEddThreshold(e.target.value.replace(/[^0-9]/g, ""))
              }
...
function APIKeysTab() {
  ...
  const [webhookUrl, setWebhookUrl] = useState(
    "https://api.alansari-exchange.ae/webhooks/noblepay",
  );
...
function NotificationsTab() {
  ...
  const [emailRecipients, setEmailRecipients] = useState(
    "compliance@alansari-exchange.ae, ops@alansari-exchange.ae",
  );
    ...
    <div className="space-y-6">
      ...
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="space-y-1">
          <ToggleSwitch
            enabled={paymentEmail}
            onChange={setPaymentEmail}
            label="Email notifications"
          />
          <ToggleSwitch
            enabled={paymentWebhook}
            onChange={setPaymentWebhook}
            label="Webhook notifications"
          />
          <ToggleSwitch
            enabled={paymentOnChain}
            onChange={setPaymentOnChain}
            label="On-chain event indexing"
          />
        </div>
      </GlassCard>
      ...
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="space-y-1">
          <ToggleSwitch
            enabled={complianceInfo}
            onChange={setComplianceInfo}
            label="Info alerts (routine checks)"
          />
          <ToggleSwitch
            enabled={complianceWarning}
            onChange={setComplianceWarning}
            label="Warning alerts (flags for review)"
          />
          <ToggleSwitch
            enabled={complianceCritical}
            onChange={setComplianceCritical}
            label="Critical alerts (blocked payments)"
          />
        </div>
      </GlassCard>
      ...
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="space-y-1">
          <ToggleSwitch
            enabled={settlementConfirm}
            onChange={setSettlementConfirm}
...
function SecurityTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <GlassCard className="p-6" hover={false}>
        ...
        <div className="mt-4">
          <ToggleSwitch
            ...
            label="Enable 2FA for all operations"
          />
        </div>
      </GlassCard>
          ...
          {sessions.map((session) => (
            ...
            >
              <div className="flex items-center gap-3">
                <Monitor
                  className={`h-5 w-5 ${session.current ? "text-emerald-400" : "text-slate-400"}`}
                />
                <div>
      ...
      <GlassCard className="p-6" hover={false}>
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              Rotate your TEE signing key. Current key age:{" "}
      ...
      {/* Emergency Freeze */}
      <GlassCard
        className={`p-6 ${emergencyFreeze ? "border-red-500/50" : ""}`}
        hover={false}
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Immediately halt all payment processing. This will block all
              outgoing transactions until manually unfrozen.
            </p>
            <div className="mt-4">
              <ToggleSwitch
                ...
                label={
                  emergencyFreeze
                    ? "FREEZE ACTIVE - All payments halted"
            ...
            {emergencyFreeze && (
              <div className="mt-3 rounded-lg border border-red-500/30 bg-red-500/10 p-3">
                <p className="text-xs text-red-300">
                  All payment processing is currently frozen. No outgoing
                  transactions will be processed until this is disabled.
                </p>
              </div>
            )}
          </div>
