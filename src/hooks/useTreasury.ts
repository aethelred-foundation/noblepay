...
const MOCK_PROPOSALS: TreasuryProposal[] = [
  {
    ...
    description:
      "Allocate 500,000 USDC to deploy three additional TEE compliance nodes in the UAE and Saudi Arabia regions.",
  ...
  },
  {
    ...
    description:
      "Allocate 150,000 USDC for Q2 marketing and partnership initiatives across GCC markets.",
  ...
  },
  {
    ...
    description:
      "Annual security audit retainer with Trail of Bits for continuous smart contract review.",
...
const MOCK_POLICIES: SpendingPolicy[] = [
  ...
  },
  {
    ...
    description:
      "Policy for yield deployment and strategic protocol investments.",
    maxSingleTx: 500_000,
...
export function useTreasury() {
  ...
  const voteOnProposal = useCallback((proposalId: string, support: boolean) => {
    setProposals((prev) =>
      prev.map((p) =>
        p.id === proposalId
          ? {
