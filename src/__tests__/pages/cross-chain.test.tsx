...
describe("CrossChainPage", () => {
  ...
  it("displays cross-chain KPI data", () => {
    ...
    expect(
      screen.getAllByText(/Cross-Chain Transfers/i).length,
    ).toBeGreaterThan(0);
  });
  ...
  it("displays transfer status badges", () => {
    ...
    expect(
      screen.getAllByText(/In Progress|Completed|Failed/).length,
    ).toBeGreaterThan(0);
  });
  ...
  it("displays step progress indicators", () => {
    ...
    expect(
      screen.getAllByText(/Initiated|Relaying|Confirming/).length,
    ).toBeGreaterThan(0);
  });
