...
describe("CompliancePage", () => {
  ...
  it("filter pills change active state", () => {
    ...
    const filterPills = buttons.filter((b) =>
      ["All", "Clear", "Review", "Flagged", "Pending"].includes(
        b.textContent || "",
      ),
    );
  ...
  it("investigations section shows outcome color styles", () => {
    ...
    const investigationsBtn = screen
      .getAllByRole("button")
      .find((b) => b.textContent?.includes("Investigations"));
  ...
  it("toggleRule expands and collapses a rule section", () => {
    ...
    const velocityBtn = screen
      .getAllByRole("button")
      .find((b) => b.textContent?.includes("Velocity Check"));
    if (velocityBtn) {
  ...
  it("ruleToggles toggle button on Velocity Check", () => {
    ...
    const velocitySection = screen
      .getAllByRole("button")
      .filter((b) => b.textContent?.includes("Velocity Check"));
