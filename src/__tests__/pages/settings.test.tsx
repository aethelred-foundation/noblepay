...
describe("SettingsPage", () => {
  ...
  it("security tab emergency freeze toggle works", () => {
    ...
    const freezeToggle = screen
      .getByText("System operating normally")
      .closest("div")
  ...
  it("notifications tab toggle switches work", () => {
    ...
    const toggleBtns = allBtns.filter(
      (b) =>
  ...
  it("security tab IP whitelist textarea works", () => {
    ...
    if (textareas.length > 0) {
      fireEvent.change(textareas[0], {
        target: { value: "192.168.1.0/24, 10.0.0.1" },
      });
    }
  });
  ...
  it("risk tolerance Conservative branch", () => {
    ...
    expect(screen.getAllByText("Conservative").length).toBeGreaterThanOrEqual(
      1,
    );
  });
