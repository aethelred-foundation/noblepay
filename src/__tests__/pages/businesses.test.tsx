...
describe("BusinessesPage", () => {
  ...
  it("opens registration modal on button click", () => {
    ...
    expect(
      screen.getAllByText(/Register New Business/i).length,
  ...
  it("registration modal X close button works (line 865)", () => {
    ...
    const headerBtns = modalContent!.querySelectorAll(
  ...
  it("pagination prev button navigates backward from page 2 (line 540)", () => {
    ...
    const page2After = screen
      .getAllByRole("button")
      .find((b) => b.textContent === "2" && b.className.includes("bg-red-600"));
  ...
  it("pagination next button navigates to page 2 (line 560)", () => {
    ...
    const iconBtns = allBtns.filter((b) => {
      return (
        b.className.includes("border-slate-700") &&
        b.className.includes("bg-slate-800") &&
