...
export function SearchOverlay() {
  ...
  const searchItems = [
    ...
    },
    {
      ...
      href: "/businesses?action=register",
      section: "Actions",
    },
    {
      label: "Export Audit Logs",
      href: "/audit?action=export",
      section: "Actions",
    },
  ];
          ...
          <div className="max-h-80 overflow-y-auto p-2">
            {filtered.length === 0 ? (
              ...
              filtered.map((item) => (
                ...
                >
                  <span className="text-2xs text-slate-500 w-12">
                    {item.section}
                  </span>
                  {item.label}
                </Link>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <p className="text-xs text-slate-600">
            &copy; 2026 Aethelred. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
